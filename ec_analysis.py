# This script is modified from SOFTX-D-20-00057/impedimetric_analysis
#Git:  https://github.com/ElsevierSoftwareX/SOFTX-D-20-00057/tree/master/Impedimetric_analysis
#@author: Karnegre
#2022/08/09
...
from thefunc import Analysis_CV
...
class App:
    def __init__(self,master):
        self.master = master
        master.title('Poodle Electrochem analysis')
    ...
    def info_box2(self):
        ...
        #     Text = "Check your excel/csv file and list the column number of where the x-values appear."
        tk.messagebox.showinfo("Info",str(Text))
...
#command is the beginning of tk element aka the gui
root = tk.Tk()

#this is the gui and it calls upon the app class above
gui = App(root)

#command is the end of the tk element
root.mainloop()
